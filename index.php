...
<head>
	...
	<!--Adds-on CSS-->
	<link rel="stylesheet" href="assets/css/adds-on.css">
	<!--Add on for about us quote design-->
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<nav class="navbar navbar-expand-lg fixed-top">
		<div class="container">
			<a class="navbar-brand" href="#"><img style="width: 110px; height: 45px;"
					src="assets/images/logo/Erovoutika Light Logo.png"></a>
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				<div class="d-lg-none d-flex justify-content-between px-4 py-3 align-items-center">
					<img src="assets/images/logo/Erovoutika Dark Logo.png" class="logo-mobile-menu" alt="logo">
				...
				<ul class="navbar-nav ml-auto align-items-center">
					...
					<li class="nav-item">
						<a class="nav-link" href="https://eira.erovoutika.ph/" target="_blank">Academy</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="https://intern.erovoutika.ph/">Interns</a>
					</li>
					<li class="nav-item">
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						<address>
							<p>8 Phase 3101 Santa Rosa City Laguna <br> (Philippines)</p>
					...
					<div class="col-sm-4">
						<div class="social-icons">
							...
							<div class="d-flex">
								<a href="https://www.linkedin.com/company/erovoutika"><i
										class="mdi mdi-linkedin"></i></a>
								<a href="https://www.facebook.com/erovoutika/"><i class="mdi mdi-facebook-box"></i></a>
								<a href="https://twitter.com/erovoutika"><i class="mdi mdi-twitter"></i></a>
								<a href="https://www.instagram.com/erovoutika/?hl=en"><i
						...
						<div class="row">
							<div class="col-sm-12">
								<ul id="list-footer">
									...
									<li class="nav-item">
										<a class="nav-link" href="https://shop.erovoutika.ph/">Products</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="https://intern.erovoutika.ph/">Interns</a>
									</li>
	...
	<!--Adds-on JS-->
	<script src="assets/js/adds-on.js"></script>
	<!--Modal JS-->
